...
public class forget_password_activity extends AppCompatActivity {
    ...
    {
        String userID = Objects.requireNonNull(user_id.getText()).toString().trim();
        ...
        if (null != activeNetwork) {
            ...
            reference1 = FirebaseDatabase.getInstance("https://vee2-a7bb5-default-rtdb.firebaseio.com/").getReference("user");
            Query checkUser = reference1.orderByChild("userId").equalTo(userID);
